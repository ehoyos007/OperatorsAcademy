...
try {
  ...
  updateSlugs = (u.updates || []).map((x) => x.slug);
} catch { /* updates optional */ }
const urls = [
  ...
  `  <url><loc>${BASE}/stacks</loc><changefreq>weekly</changefreq><priority>0.7</priority></url>`,
  `  <url><loc>${BASE}/updates</loc><changefreq>daily</changefreq><priority>0.7</priority></url>`,
  ...
  ...updateSlugs.map((s) => `  <url><loc>${BASE}/updates/${s}</loc><changefreq>monthly</changefreq><priority>0.5</priority></url>`),
];
